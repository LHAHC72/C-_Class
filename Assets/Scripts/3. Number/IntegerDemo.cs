...
public class IntegerDemo : MonoBehaviour
{
    ...
    void Start()
    {
        //SignedInterger : (+,-) 부호가 있는 정수형 데이터 형식
        sbyte iSbyte = 127;
        short iInt16 = 32767;
        ...
        byte iByte = 255;
        ushort iUshort = 65535;
        uint iUint = uint.MaxValue;
        ulong iUlong = ulong.MaxValue;

        Debug.Log("iByte:" + iByte);
        Debug.Log("iUshort:" + iUshort);
        Debug.Log("iUint:" + iUint);
        Debug.Log("iUlong:" + iUlong);
    }
