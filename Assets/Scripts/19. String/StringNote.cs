...
public class StringNote : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(str[5]);  // 대문자로 변환해서 출력
        Debug.Log(str.ToUpper()); // 대문자로 변환해서 출력
        Debug.Log(str.ToLower()); // 소문자로 변환해서 출력

        // 공백 제거
        Debug.Log(str.Trim()); // 앞 뒤 공백 제거
        Debug.Log(str.TrimStart()); // 앞 공백 제거
        Debug.Log(str.TrimEnd()); // 뒷 공백 제거

        // 검색
        Debug.Log(str.IndexOf('e'));   // 'e'가 위치한 인덱스(방위치) 가져오기
        Debug.Log(str.Substring(5,3));   // 5번 인덱스(방위치)부터 3글자 가져오기
        Debug.Log(str.Substring(5));   // 5번 인덱스(방위치)부터 끝까지 가져오기
        Debug.Log(str.Remove(5,3));   // 5번 인덱스(방위치)부터 3글자 삭제하기
        Debug.Log(str.Remove(5));   // 5번 인덱스(방위치)부터 끝까지 삭제하기
        ...
        Debug.Log(System.String.Format("{0:#,###}", 10000000)); // 세자리 콤마

        // 바꾸기
        string message = "Hello World";
        Debug.Log(message.Replace("Hello","안녕하세요"));    // "안녕하세요 world"
        Debug.Log(message.Replace("Hello", "안녕하세요").Replace("World", "세계"));    // "안녕하세요 세계"
